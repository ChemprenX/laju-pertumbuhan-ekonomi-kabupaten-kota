...
export default {
  ...
  mounted: function () {
    axios.get('/json/bantenprov/lpe-kabupaten-kota/lpe-kabupaten-kota-020.json').then(response => {
      ...
      this.bar.title.text =   ' Tahun ' + res[0].xAxis.yyyy;
      ...
      setInterval(() => {
        ...
        this.bar.title.text =   ' Tahun ' + res[i].xAxis.yyyy;
