      ...
      <div class="col-md-8 col-lg-9 admin-main">
        ...
        <div class="col-md-12">
          <div class="card mb-3">
            ...
            <div class="card-body">
            <b-card header="Tambah LPE Kabupaten Kota" header-tag="h4" class="bg-success-card">
    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/lpe-kabupaten-kota/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/lpe-kabupaten-kota/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/lpe-kabupaten-kota/create'
                  }
                },
                window.location.href = '#/admin/lpe-kabupaten-kota/create')
        ...
        back() {
            window.location = '#/admin/lpe-kabupaten-kota';
        }
    },
    mounted: function() {
        axios.get("/lpe-kabupaten-kota/create").then(response => {
